...
func TestCheckpointRestorePTY(t *testing.T) {
	...
	checkpoint, err := container.Checkpoint(ctx, testCheckpointName+"withpty", nil, []CheckpointOpts{
...
func TestCheckpointRestore(t *testing.T) {
	...
	checkpoint, err := container.Checkpoint(ctx, testCheckpointName+"restore", nil, []CheckpointOpts{
		WithCheckpointRuntime,
		WithCheckpointRW,
		WithCheckpointTask,
	}...)
...
func TestCheckpointRestoreNewContainer(t *testing.T) {
	...
	checkpoint, err := container.Checkpoint(ctx, testCheckpointName+"newcontainer", nil, []CheckpointOpts{
		WithCheckpointRuntime,
		WithCheckpointRW,
		WithCheckpointTask,
	}...)
...
func TestCheckpointLeaveRunning(t *testing.T) {
	...
	// checkpoint
	if _, err := container.Checkpoint(ctx, testCheckpointName+"leaverunning", nil, []CheckpointOpts{
		WithCheckpointRuntime,
		WithCheckpointRW,
		WithCheckpointTask,
	}...); err != nil {
...
func TestCheckpointOnPauseStatus(t *testing.T) {
	...
	_, err = container.Checkpoint(ctx, testCheckpointName+"on-pause", nil, []CheckpointOpts{
		WithCheckpointRuntime,
		WithCheckpointRW,
		WithCheckpointTask,
	}...)
